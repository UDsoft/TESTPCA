...
public class TestPCABoard {
    ...
    public static void main(String args[]) throws Exception { 
       ...
       //gpioProvider.setAlwaysOn(PCA9685Pin.PWM_00); 
        ...
        gpioProvider.setPwm(PCA9685Pin.PWM_12, SERVO_DURATION_NEUTRAL); 
        // Set 2.1ms pulse (R/C Servo maximum position)  
        gpioProvider.setPwm(PCA9685Pin.PWM_13, SERVO_DURATION_MAX); 
